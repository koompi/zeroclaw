---
name: sync
description: Universal context primer. When Boss says "@edith sync" or "sync", immediately load all memory, check infrastructure, and report active state. Use when switching topics or starting a new session mid-day.
---

# Sync — Full Context Primer

**Trigger:** Boss says "sync" or "@edith sync" in any topic.
...
4. **Report format**
   ...
   ⚠️ Open Items: [anything needing Boss attention]
